...
bool Interactive(Item? item,Minion? monster)///метод с помощью которого мы выбираем текущее действие
{
    ...
    {
        Console.WriteLine("Выберите действие: 1.Идти 2.Подобрать 3.Показать инвентарь 4.Показать инфо о себе 5.Закончить игру");
    }
    ...
    {
        Console.WriteLine("Выберите действие: 1.Идти 3.Показать инвентарь 4.Показать инфо о себе 5.Закончить игру");
    }
        ...
        case 2:
            {
                ...
                return false;///эти тру фолс для отслеживания действий(к примеру чтобы после просмотра ивентаря или инфо о себе не генерировался новый предмет, а мы взаимодействовали с тем же что уже был сгенерирован и ожидает дейтсвия)
            }
        case 3:
            {
